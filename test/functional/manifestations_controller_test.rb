...
class ManifestationsControllerTest < ActionController::TestCase
  ...
  def test_librarian_should_not_get_new_with_expression_id
    sign_in users(:librarian1)
    get :new, :expression_id => 1
    assert_response :forbidden
  end
  
  def test_admin_should_not_get_new_without_expression_id
    sign_in users(:admin)
    get :new
    assert_response :forbidden
  end
  
  def test_admin_should_not_get_new_with_expression_id
    sign_in users(:admin)
    get :new, :expression_id => 1
    assert_response :forbidden
  end
